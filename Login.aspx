<%@ Page Title="Login" Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="Login.aspx.cs" Inherits="FSC.Login" %>
...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
     ...
     <div class="jumbotron" style="text-align:center;">
        ...
        <h3>Welcome to BD Learning management system</h3>
        <table class="center" >
            <tr>
                <td>Username:</td>
         ...
         <!--<asp:Button id="btn_CreateAccount" runat="server" CssClass="btn btn-primary" Text="Create an account" OnClick="btn_CreateAccount_Click" />-->
