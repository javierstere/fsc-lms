<NewDataSet>
  <sp_help>
    <Name>Outpost_SessionStorage</Name>
    <Owner>dbo</Owner>
    <Type>user table</Type>
    <Created_datetime>2019-03-03T05:07:25.4+02:00</Created_datetime>
  </sp_help>
  <sp_help1>
  ...
  <sp_help1>
    <Column_name>SessionId</Column_name>
    <Type>varchar</Type>
    <Computed>no</Computed>
    <Length>50</Length>
  ...
  <sp_help1>
    <Column_name>ExpireAt</Column_name>
    <Type>datetime</Type>
    <Computed>no</Computed>
    <Length>8</Length>
    <Prec xml:space="preserve">     </Prec>
  ...
  <sp_help5>
    <index_name>PK_Outpost_SessionStorage</index_name>
  ...
  <sp_help6>
    ...
    <constraint_name>PK_Outpost_SessionStorage</constraint_name>
