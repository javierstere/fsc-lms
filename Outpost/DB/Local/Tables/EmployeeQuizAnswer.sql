<NewDataSet>
  <sp_help>
    <Name>EmployeeQuizAnswer</Name>
    <Owner>dbo</Owner>
    <Type>user table</Type>
    <Created_datetime>2019-02-12T22:35:30.277+02:00</Created_datetime>
  </sp_help>
  <sp_help1>
    <Column_name>IdEmployeeQuizAnswer</Column_name>
    <Type>int</Type>
  ...
  <sp_help1>
    <Column_name>IdEmployeeQuiz</Column_name>
    <Type>int</Type>
    <Computed>no</Computed>
    <Length>4</Length>
    <Prec>10   </Prec>
  ...
  <sp_help1>
    <Column_name>IdQuizQuestion</Column_name>
    <Type>int</Type>
    <Computed>no</Computed>
    <Length>4</Length>
    <Prec>10   </Prec>
  ...
  <sp_help2>
    <Identity>IdEmployeeQuizAnswer</Identity>
    <Seed>1</Seed>
  ...
  <sp_help5>
    <index_name>PK_EmployeeQuizAnswer</index_name>
    <index_description>clustered, unique, primary key located on PRIMARY</index_description>
    <index_keys>IdEmployeeQuizAnswer</index_keys>
  </sp_help5>
  <sp_help6>
    <constraint_type>PRIMARY KEY (clustered)</constraint_type>
    <constraint_name>PK_EmployeeQuizAnswer</constraint_name>
    ...
    <constraint_keys>IdEmployeeQuizAnswer</constraint_keys>
  </sp_help6>
</NewDataSet>