<NewDataSet>
  <sp_help>
    <Name>EmployeeQuiz</Name>
    <Owner>dbo</Owner>
    <Type>user table</Type>
    <Created_datetime>2019-02-12T22:35:30.267+02:00</Created_datetime>
  </sp_help>
  <sp_help1>
  ...
  <sp_help1>
    <Column_name>StartCount</Column_name>
    <Type>int</Type>
    <Computed>no</Computed>
    <Length>4</Length>
    <Prec>10   </Prec>
  ...
  <sp_help2>
    <Identity>IdEmployeeQuiz</Identity>
    <Seed>1</Seed>
  ...
  <sp_help6>
    ...
    <constraint_keys>IdEmployeeQuiz</constraint_keys>
  </sp_help6>
</NewDataSet>