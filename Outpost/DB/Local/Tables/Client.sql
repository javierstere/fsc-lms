<NewDataSet>
  <sp_help>
    ...
    <Created_datetime>2019-02-12T22:35:30.223+02:00</Created_datetime>
  </sp_help>
  <sp_help1>
  ...
  <sp_help1>
    <Column_name>ClientName</Column_name>
    <Type>varchar</Type>
    <Computed>no</Computed>
    <Length>100</Length>
  ...
  <sp_help1>
    <Column_name>MaxEmployees</Column_name>
    <Type>int</Type>
    <Computed>no</Computed>
    <Length>4</Length>
    <Prec>10   </Prec>
  ...
  <sp_help1>
    <Column_name>ContactPerson</Column_name>
    <Type>varchar</Type>
    <Computed>no</Computed>
    <Length>200</Length>
    <Prec xml:space="preserve">     </Prec>
  ...
  <sp_help1>
    <Column_name>AccessEmail</Column_name>
    <Type>varchar</Type>
    <Computed>no</Computed>
    <Length>100</Length>
    <Prec xml:space="preserve">     </Prec>
  ...
  <sp_help1>
    <Column_name>TitleRole</Column_name>
    <Type>varchar</Type>
    <Computed>no</Computed>
    <Length>200</Length>
    <Prec xml:space="preserve">     </Prec>
  ...
  <sp_help1>
    <Column_name>MaxAdmins</Column_name>
    <Type>int</Type>
    <Computed>no</Computed>
    <Length>4</Length>
    <Prec>10   </Prec>
  ...
  <sp_help1>
    <Column_name>MaxUniversities</Column_name>
    <Type>int</Type>
    <Computed>no</Computed>
    <Length>4</Length>
    <Prec>10   </Prec>
  ...
  <sp_help1>
    <Column_name>MaxModules</Column_name>
    <Type>int</Type>
    <Computed>no</Computed>
    <Length>4</Length>
    <Prec>10   </Prec>
  ...
  <sp_help1>
    <Column_name>MaxProjects</Column_name>
    <Type>int</Type>
    <Computed>no</Computed>
    <Length>4</Length>
    <Prec>10   </Prec>
  ...
  <sp_help6>
    ...
    <constraint_keys>IdClient</constraint_keys>
  </sp_help6>
</NewDataSet>